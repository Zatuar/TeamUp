...
public class AnnonceAdapter extends RecyclerView.Adapter<AnnonceAdapter.Holder>  {
    ...
    public AnnonceAdapter(ArrayList<Annonce> annoncesList, ClickAnnonceListener clickAnnonceListener, Context context) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        final Annonce key = annoncesList.get(position);
    ...
    public void setItem(ArrayList<Annonce> annonces) {
