...
public class TeamListMemberAdapter extends RecyclerView.Adapter<TeamListMemberAdapter.Holder> {
    private ArrayList<Structure_Profil_Min> membersList;
    private ClickMemberListener clickMemberListener;
    private Context context;

    public TeamListMemberAdapter(ArrayList<Structure_Profil_Min> membersList, ClickMemberListener clickMemberListener, Context context) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        final Structure_Profil_Min key = membersList.get(position);
